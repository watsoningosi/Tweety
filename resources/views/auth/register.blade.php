<x-master>
    <div class="mx-auto flex justify-center">
        ...
        <div style="max-width: 700px;" class="">
            ...
            <div class="px-32 py-16 bg-gray-100">
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label for=""
                            class="block mb-2 uppercase font-bold text-xs">{{ __('Avatar') }}</label>
                    ...
                    <textarea name="description" value="{{ old('description') }}" class="border border-blue-400 w-full p-2"
                        id="description" cols="30" rows="4"></textarea>

                    <div class="row mb-3">
                        <label for="password"
                            class="block mb-2  uppercase font-bold text-xs">{{ __('Password') }}</label>
                    ...
                    <div class="row mb-0">
                        <div class="col-md-6 offset-md-4">
                            <button type="submit"
                                class="px-4 py-2 mt-3 rounded text-white text-sm uppercase bg-blue-400">
                                {{ __('Register') }}
                            </button>
                        </div>
                    </div>
